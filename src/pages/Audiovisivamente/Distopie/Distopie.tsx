...
const aiImages = [
    '01.webp','02.webp','03.webp','4.webp','5.webp',
    '6.webp','7.webp','08.webp','9.webp','10.webp'
...
const Distopie = () => {
    ...
    return (
        <div className="page audiovisivamente__page" id="audiovisivamente__distopie">
            ...
            <section className="section top">
                <div ref={heroDescrRef} className={`content hero_desc_wrapper ${inViewHeroDescr ? "inView" : ""}`}>
                    <p lang="it">
                        ...
                        in un viaggio completo nel mondo della Intelligenza Artificiale, tra storia, funzionamento e utilizzi strategici
            ...
            <section className="section bottom heroAudio">
